...
SYSTEM_PROMPT = "you are a helpful home finder assistant. " \
"You will be supplied with home search criteria. " \
"You will return a list of homes that match the criteria. " 
...
async def start_chat():
    ...
    # Single welcome message with all content - no other UI elements
    welcome_content = "# Welcome to ElastiChat\n\n"
    welcome_content += "This app integrates with Azure OpenAI and supports Elastic Vector Database tool calling.\n\n"
    ...
    # Send a single welcome message with all content
    await cl.Message(
